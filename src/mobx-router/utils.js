...
const viewsForHttpDirector = (views, store, callback) =>
    getObjectKeys(views).reduce((obj, viewKey) => {
        const view = views[viewKey];
        obj[view.path] = { get: (...paramsArr) => {
...
export {isObject, getObjectKeys, viewsForDirector, viewsForHttpDirector, getRegexMatches};
