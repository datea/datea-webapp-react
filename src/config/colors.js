...
const chartColors = [
  material.red['900'], material.pink['300'], material.purple['500'], material.deepPurple['900'], material.indigo['300'],
  material.blue['500'], material.cyan['500'], material.teal['500'], material.green['500'], material.lightGreen['100'],
  material.lime['500'], material.yellow['500'], material.amber['900'], material.deepOrange['900'], material.brown['300'],
  material.blueGrey['300']
]
export {chartColors};

const defaultLayerColor = '#28BC45';
export {defaultLayerColor}
